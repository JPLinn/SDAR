...
class Net(nn.Module):
    def __init__(self, params):
        ...
        self.distribution_pre_mu = nn.Linear(params.lstm_hidden_dim * params.lstm_layers, 1)
        self.distribution_pre_sigma = nn.Linear(params.lstm_hidden_dim * params.lstm_layers, 1)
        self.distribution_sigma = nn.Softplus()
        self.distribution_mu = nn.Sigmoid()
    ...
    def forward(self, x, idx, hidden, cell):
        ...
        pre_mu = self.distribution_pre_mu(hidden_permute)
        mu = self.distribution_mu(pre_mu)
